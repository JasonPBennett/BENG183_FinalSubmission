...
![An overview of the 3C process.](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5845197/bin/13039_2018_368_Fig1_HTML.jpg) 
...
![Large-scale Hi-C visualization techniques](https://media.springernature.com/full/springer-static/image/art:10.1186/s13059-017-1161-y/MediaObjects/13059_2017_1161_Fig1_HTML.gif =600x600)***Figure 2**: Four different large-scale chromatin interaction visualizations. **a.)** Hi-C interactions across all chromosomes in a kidney sample. The green arrow indicates a highly interacting set of samples **b.)** Visualization of the murine X chromosome **c.)** One locus within the murine X visualized using a heatmap **d.)** A circle plot generated from the interactions found in the murine X chromosome with the green arrow indicating the locus plotted in the previous heatmap in c [5]*
...
![Local Hi-C visualization](https://media.springernature.com/full/springer-static/image/art:10.1186/s13059-017-1161-y/MediaObjects/13059_2017_1161_Fig2_HTML.gif =656x1600)
***Figure 3:** Local chromatin interaction visualization techniques. **a.)** A cartoon of a single loop of chromatin joined by two proteins **b.)** The circle plot showing the interacting segments **c.)** Using the genome browser to identify promoter/enhancer regions indicated by the Hi-C data [5]*
